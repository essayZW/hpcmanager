...
var file_proto_usergroup_proto_rawDesc = []byte{
	...
	0x32, 0xb6, 0x03, 0x0a, 0x0c, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x68, 0x54, 0x75, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1c, 0x2e, 0x75, 0x73, 0x65,
...
var file_proto_usergroup_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_proto_usergroup_proto_goTypes = []interface{}{
	...
	(*GroupInfo)(nil),                      // 9: user.GroupInfo
...
var file_proto_usergroup_proto_depIdxs = []int32{
	8,  // 0: user.GetGroupInfoByIDRequest.baseRequest:type_name -> request.BaseRequest
	9,  // 1: user.GetGroupInfoByIDResponse.groupInfo:type_name -> user.GroupInfo
	8,  // 2: user.PaginationGetGroupInfoRequest.baseRequest:type_name -> request.BaseRequest
	9,  // 3: user.PaginationGetGroupInfoResponse.groupInfos:type_name -> user.GroupInfo
	8,  // 4: user.CreateJoinGroupApplyRequest.baseRequest:type_name -> request.BaseRequest
	8,  // 5: user.SearchTutorInfoRequest.baseRequest:type_name -> request.BaseRequest
	10, // 6: user.GroupService.Ping:input_type -> publicproto.Empty
	0,  // 7: user.GroupService.GetGroupInfoByID:input_type -> user.GetGroupInfoByIDRequest
	2,  // 8: user.GroupService.PaginationGetGroupInfo:input_type -> user.PaginationGetGroupInfoRequest
	4,  // 9: user.GroupService.CreateJoinGroupApply:input_type -> user.CreateJoinGroupApplyRequest
	6,  // 10: user.GroupService.SearchTutorInfo:input_type -> user.SearchTutorInfoRequest
	11, // 11: user.GroupService.Ping:output_type -> publicproto.PingResponse
	1,  // 12: user.GroupService.GetGroupInfoByID:output_type -> user.GetGroupInfoByIDResponse
	3,  // 13: user.GroupService.PaginationGetGroupInfo:output_type -> user.PaginationGetGroupInfoResponse
	5,  // 14: user.GroupService.CreateJoinGroupApply:output_type -> user.CreateJoinGroupApplyResponse
	7,  // 15: user.GroupService.SearchTutorInfo:output_type -> user.SearchTutorInfoResponse
