...
var file_proto_usergroup_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x44, 0x32, 0xa3,
...
var file_proto_usergroup_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_usergroup_proto_goTypes = []interface{}{
	...
	(*GroupInfo)(nil),                      // 15: user.GroupInfo
	(*UserGroupApply)(nil),                 // 16: user.UserGroupApply
...
var file_proto_usergroup_proto_depIdxs = []int32{
	14, // 0: user.GetGroupInfoByIDRequest.baseRequest:type_name -> request.BaseRequest
	15, // 1: user.GetGroupInfoByIDResponse.groupInfo:type_name -> user.GroupInfo
	14, // 2: user.PaginationGetGroupInfoRequest.baseRequest:type_name -> request.BaseRequest
	15, // 3: user.PaginationGetGroupInfoResponse.groupInfos:type_name -> user.GroupInfo
	14, // 4: user.CreateJoinGroupApplyRequest.baseRequest:type_name -> request.BaseRequest
	14, // 5: user.SearchTutorInfoRequest.baseRequest:type_name -> request.BaseRequest
	14, // 6: user.PageGetApplyGroupInfoRequest.baseRequest:type_name -> request.BaseRequest
	16, // 7: user.PageGetApplyGroupInfoResponse.applies:type_name -> user.UserGroupApply
	14, // 8: user.CheckApplyRequest.baseRequest:type_name -> request.BaseRequest
	14, // 9: user.CreateGroupRequest.baseRequest:type_name -> request.BaseRequest
	17, // 10: user.GroupService.Ping:input_type -> publicproto.Empty
	0,  // 11: user.GroupService.GetGroupInfoByID:input_type -> user.GetGroupInfoByIDRequest
	2,  // 12: user.GroupService.PaginationGetGroupInfo:input_type -> user.PaginationGetGroupInfoRequest
	4,  // 13: user.GroupService.CreateJoinGroupApply:input_type -> user.CreateJoinGroupApplyRequest
	6,  // 14: user.GroupService.SearchTutorInfo:input_type -> user.SearchTutorInfoRequest
	8,  // 15: user.GroupService.PageGetApplyGroupInfo:input_type -> user.PageGetApplyGroupInfoRequest
	10, // 16: user.GroupService.CheckApply:input_type -> user.CheckApplyRequest
	12, // 17: user.GroupService.CreateGroup:input_type -> user.CreateGroupRequest
	18, // 18: user.GroupService.Ping:output_type -> publicproto.PingResponse
	1,  // 19: user.GroupService.GetGroupInfoByID:output_type -> user.GetGroupInfoByIDResponse
	3,  // 20: user.GroupService.PaginationGetGroupInfo:output_type -> user.PaginationGetGroupInfoResponse
	5,  // 21: user.GroupService.CreateJoinGroupApply:output_type -> user.CreateJoinGroupApplyResponse
	7,  // 22: user.GroupService.SearchTutorInfo:output_type -> user.SearchTutorInfoResponse
	9,  // 23: user.GroupService.PageGetApplyGroupInfo:output_type -> user.PageGetApplyGroupInfoResponse
	11, // 24: user.GroupService.CheckApply:output_type -> user.CheckApplyResponse
	13, // 25: user.GroupService.CreateGroup:output_type -> user.CreateGroupResponse
