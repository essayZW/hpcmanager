...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x69, 0x64, 0x32, 0xbc, 0x02, 0x0a,
	0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x37, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x2e,
	...
	0x50, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x32,
...
var file_proto_user_proto_depIdxs = []int32{
	8,  // 0: user.LoginRequest.baseRequest:type_name -> request.BaseRequest
	9,  // 1: user.LoginResponse.userInfo:type_name -> user.UserInfo
	8,  // 2: user.CheckLoginRequest.baseRequest:type_name -> request.BaseRequest
	9,  // 3: user.CheckLoginResponse.userInfo:type_name -> user.UserInfo
	8,  // 4: user.ExistUsernameRequest.baseRequest:type_name -> request.BaseRequest
	8,  // 5: user.AddUserRequest.baseRequest:type_name -> request.BaseRequest
	9,  // 6: user.AddUserRequest.userInfo:type_name -> user.UserInfo
	10, // 7: user.User.Ping:input_type -> publicproto.Empty
	0,  // 8: user.User.Login:input_type -> user.LoginRequest
	2,  // 9: user.User.CheckLogin:input_type -> user.CheckLoginRequest
	4,  // 10: user.User.ExistUsername:input_type -> user.ExistUsernameRequest
	6,  // 11: user.User.AddUser:input_type -> user.AddUserRequest
	11, // 12: user.User.Ping:output_type -> publicproto.PingResponse
	1,  // 13: user.User.Login:output_type -> user.LoginResponse
	3,  // 14: user.User.CheckLogin:output_type -> user.CheckLoginResponse
	5,  // 15: user.User.ExistUsername:output_type -> user.ExistUsernameResponse
	7,  // 16: user.User.AddUser:output_type -> user.AddUserResponse
