...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xec, 0x04,
	0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x37, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x12,
...
var file_proto_user_proto_depIdxs = []int32{
	16, // 0: user.LoginRequest.baseRequest:type_name -> request.BaseRequest
	17, // 1: user.LoginResponse.userInfo:type_name -> user.UserInfo
	16, // 2: user.CheckLoginRequest.baseRequest:type_name -> request.BaseRequest
	17, // 3: user.CheckLoginResponse.userInfo:type_name -> user.UserInfo
	16, // 4: user.ExistUsernameRequest.baseRequest:type_name -> request.BaseRequest
	16, // 5: user.AddUserRequest.baseRequest:type_name -> request.BaseRequest
	17, // 6: user.AddUserRequest.userInfo:type_name -> user.UserInfo
	16, // 7: user.CreateTokenRequest.baseRequest:type_name -> request.BaseRequest
	17, // 8: user.CreateTokenResponse.userInfo:type_name -> user.UserInfo
	16, // 9: user.GetUserInfoRequest.baseRequest:type_name -> request.BaseRequest
	17, // 10: user.GetUserInfoResponse.userInfo:type_name -> user.UserInfo
	16, // 11: user.PaginationGetUserInfoRequest.baseRequest:type_name -> request.BaseRequest
	17, // 12: user.PaginationGetUserInfoResponse.userInfos:type_name -> user.UserInfo
	16, // 13: user.JoinGroupRequest.baseRequest:type_name -> request.BaseRequest
	18, // 14: user.User.Ping:input_type -> publicproto.Empty
	0,  // 15: user.User.Login:input_type -> user.LoginRequest
	2,  // 16: user.User.CheckLogin:input_type -> user.CheckLoginRequest
	4,  // 17: user.User.ExistUsername:input_type -> user.ExistUsernameRequest
	6,  // 18: user.User.AddUser:input_type -> user.AddUserRequest
	8,  // 19: user.User.CreateToken:input_type -> user.CreateTokenRequest
	10, // 20: user.User.GetUserInfo:input_type -> user.GetUserInfoRequest
	12, // 21: user.User.PaginationGetUserInfo:input_type -> user.PaginationGetUserInfoRequest
	14, // 22: user.User.JoinGroup:input_type -> user.JoinGroupRequest
	19, // 23: user.User.Ping:output_type -> publicproto.PingResponse
	1,  // 24: user.User.Login:output_type -> user.LoginResponse
	3,  // 25: user.User.CheckLogin:output_type -> user.CheckLoginResponse
	5,  // 26: user.User.ExistUsername:output_type -> user.ExistUsernameResponse
	7,  // 27: user.User.AddUser:output_type -> user.AddUserResponse
	9,  // 28: user.User.CreateToken:output_type -> user.CreateTokenResponse
	11, // 29: user.User.GetUserInfo:output_type -> user.GetUserInfoResponse
	13, // 30: user.User.PaginationGetUserInfo:output_type -> user.PaginationGetUserInfoResponse
	15, // 31: user.User.JoinGroup:output_type -> user.JoinGroupResponse
