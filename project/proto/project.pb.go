...
type PaginationGetProjectInfosRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PaginationGetProjectInfosRequest) Reset() {
	*x = PaginationGetProjectInfosRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PaginationGetProjectInfosRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaginationGetProjectInfosRequest) ProtoMessage() {}

func (x *PaginationGetProjectInfosRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_project_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaginationGetProjectInfosRequest.ProtoReflect.Descriptor instead.
func (*PaginationGetProjectInfosRequest) Descriptor() ([]byte, []int) {
	return file_proto_project_proto_rawDescGZIP(), []int{4}
}

func (x *PaginationGetProjectInfosRequest) GetBaseRequest() *proto.BaseRequest {
	if x != nil {
		return x.BaseRequest
	}
	return nil
...
func (x *PaginationGetProjectInfosRequest) GetPageIndex() int32 {
	if x != nil {
		return x.PageIndex
	}
	return 0
...
func (x *PaginationGetProjectInfosRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
type PaginationGetProjectInfosResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Infos []*ProjectInfo `protobuf:"bytes,1,rep,name=infos,proto3" json:"infos,omitempty"`
	Count int32          `protobuf:"varint,2,opt,name=count,proto3" json:"count,omitempty"`
}

func (x *PaginationGetProjectInfosResponse) Reset() {
	*x = PaginationGetProjectInfosResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PaginationGetProjectInfosResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaginationGetProjectInfosResponse) ProtoMessage() {}

func (x *PaginationGetProjectInfosResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_project_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaginationGetProjectInfosResponse.ProtoReflect.Descriptor instead.
func (*PaginationGetProjectInfosResponse) Descriptor() ([]byte, []int) {
	return file_proto_project_proto_rawDescGZIP(), []int{5}
}

func (x *PaginationGetProjectInfosResponse) GetInfos() []*ProjectInfo {
	if x != nil {
		return x.Infos
	}
	return nil
...
func (x *PaginationGetProjectInfosResponse) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_proto_project_proto_rawDesc = []byte{
	...
	0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x94,
	0x01, 0x0a, 0x20, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x47, 0x65, 0x74,
	0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x65, 0x22, 0x00, 0x12, 0x5f, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79, 0x49, 0x44, 0x12, 0x22, 0x2e, 0x70, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e,
	0x66, 0x6f, 0x42, 0x79, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x74, 0x0a, 0x19, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f,
	0x73, 0x12, 0x29, 0x2e, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x50, 0x61, 0x67, 0x69,
	0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x70,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x73,
	...
	0x2f, 0x68, 0x70, 0x63, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
...
var file_proto_project_proto_goTypes = []interface{}{
	...
	(*PaginationGetProjectInfosRequest)(nil),  // 4: project.PaginationGetProjectInfosRequest
	(*PaginationGetProjectInfosResponse)(nil), // 5: project.PaginationGetProjectInfosResponse
	(*proto.BaseRequest)(nil),                 // 6: request.BaseRequest
	(*ProjectInfo)(nil),                       // 7: project.ProjectInfo
...
var file_proto_project_proto_depIdxs = []int32{
	6,  // 0: project.CreateProjectRequest.baseRequest:type_name -> request.BaseRequest
	7,  // 1: project.CreateProjectRequest.projectInfo:type_name -> project.ProjectInfo
	6,  // 2: project.GetProjectInfoByIDRequest.baseRequest:type_name -> request.BaseRequest
	7,  // 3: project.GetProjectInfoByIDResponse.data:type_name -> project.ProjectInfo
	6,  // 4: project.PaginationGetProjectInfosRequest.baseRequest:type_name -> request.BaseRequest
	7,  // 5: project.PaginationGetProjectInfosResponse.infos:type_name -> project.ProjectInfo
	8,  // 6: project.Project.Ping:input_type -> publicproto.Empty
	0,  // 7: project.Project.CreateProject:input_type -> project.CreateProjectRequest
	2,  // 8: project.Project.GetProjectInfoByID:input_type -> project.GetProjectInfoByIDRequest
	4,  // 9: project.Project.PaginationGetProjectInfos:input_type -> project.PaginationGetProjectInfosRequest
	9,  // 10: project.Project.Ping:output_type -> publicproto.PingResponse
	1,  // 11: project.Project.CreateProject:output_type -> project.CreateProjectResponse
	3,  // 12: project.Project.GetProjectInfoByID:output_type -> project.GetProjectInfoByIDResponse
	5,  // 13: project.Project.PaginationGetProjectInfos:output_type -> project.PaginationGetProjectInfosResponse
...
func file_proto_project_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_project_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PaginationGetProjectInfosRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_project_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PaginationGetProjectInfosResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
