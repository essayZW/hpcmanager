...
var file_proto_fee_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xa9,
	0x02, 0x0a, 0x03, 0x46, 0x65, 0x65, 0x12, 0x37, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x12,
...
var file_proto_fee_proto_goTypes = []interface{}{
	...
	(*NodeDistributeBill)(nil),                      // 5: fee.NodeDistributeBill
...
var file_proto_fee_proto_depIdxs = []int32{
	4, // 0: fee.CreateNodeDistributeBillRequest.baseRequest:type_name -> request.BaseRequest
	4, // 1: fee.PaginationGetNodeDistributeBillRequest.baseRequest:type_name -> request.BaseRequest
	5, // 2: fee.PaginationGetNodeDistributeBillResponse.bills:type_name -> fee.NodeDistributeBill
	6, // 3: fee.Fee.Ping:input_type -> publicproto.Empty
	0, // 4: fee.Fee.CreateNodeDistributeBill:input_type -> fee.CreateNodeDistributeBillRequest
	2, // 5: fee.Fee.PaginationGetNodeDistributeBill:input_type -> fee.PaginationGetNodeDistributeBillRequest
	7, // 6: fee.Fee.Ping:output_type -> publicproto.PingResponse
	1, // 7: fee.Fee.CreateNodeDistributeBill:output_type -> fee.CreateNodeDistributeBillResponse
	3, // 8: fee.Fee.PaginationGetNodeDistributeBill:output_type -> fee.PaginationGetNodeDistributeBillResponse
